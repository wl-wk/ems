...
<div id="wrap">
    <div id="top_content">
        ...
        <div id="content">
            ...
            <form action="${pageContext.request.contextPath}/ems/regist" method="post">
                <table cellpadding="0" cellspacing="0" border="0"
                    ...
                    <tr>
                        <td valign="middle" align="right">
                            ...
                            <a href="javascript:;"
                               onclick="document.getElementById('num').src = '${pageContext.request.contextPath}/code/getCode?'+(new Date()).getTime()">换一张</a>
                        </td>
                        <td valign="middle" align="left">
